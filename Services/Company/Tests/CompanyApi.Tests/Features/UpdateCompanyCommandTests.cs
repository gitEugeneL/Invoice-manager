...
public class UpdateCompanyCommandTests
{
    ...
    [Fact]
    public void ValidUpdateCompanyCommand_PassesValidation()
    {
        // arrange
    ...
    public void InvalidUpdateCompanyCommand_FailsValidation(string name, string taxNumber, string city, string street, string houseNumber, string postalCode)
    {
        // arrange
        var model = new UpdateCompany.Command
        (
