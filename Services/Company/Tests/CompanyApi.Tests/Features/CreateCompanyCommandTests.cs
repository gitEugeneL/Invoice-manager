...
public class CreateCompanyCommandTests
{
    ...
    [Fact]
    public void ValidCreateUserCommand_PassesValidation()
    {
        // arrange
    ...
    public void InvalidCreateUserCommand_FailsValidation(string name, string taxNumber, string city, string street, string houseNumber, string postalCode)
    {
        // arrange
        var model = new CreateCompany.Command
        (
